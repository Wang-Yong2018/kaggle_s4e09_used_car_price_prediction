...
rcp_bs_v1 <- 
  ...
  step_corr(all_predictors())|>
  check_missing(all_predictors())
rcp_bs_v1 |>prep() |>juice()|>bake(new_data = train_set)
```
...
simple_wf_rmse
# note: TODO with log 76050, without log 72111, need check 
```
#### plot simple wflow mode residual
```{r}
simple_wf_fit |> 
  extract_fit_engine()|>
  plot()
