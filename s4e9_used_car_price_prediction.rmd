...
```{r}
train|>select(id,price,model)|>
  mutate(model_type=str_extract(tolower(model),
                                '([a-z]-class)|(premium|luxury|base|sport|premium plus|premium|matic|platinum|luxury|ultimate|xlt)|( lt)'))
